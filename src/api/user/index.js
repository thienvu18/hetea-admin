...
const { email, password, name, picture, role, isLock } = schema.tree;
 ...
 * @apiParam {Boolean} [isLock] Account's lock status.
...
router.post(
  "/",
  master(),
  body({ email, password, name, picture, role, isLock }),
  create
);
