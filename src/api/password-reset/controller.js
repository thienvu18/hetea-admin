...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your Hetea Admin account.<br>
        ...
        &mdash; Hetea Admin Team
      `
      return sendMail({ toEmail: email, subject: 'Hetea Admin - Password Reset', content })
    })
